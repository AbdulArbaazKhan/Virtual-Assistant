...
VU_frame = LabelFrame(root, text=f"Hello {username.get()}! I am Jarvis, How may I help you?", height=180, font="lucida 10 bold")
...
Button(Buttonframe, width=7, text="Quit", overrelief=SUNKEN, font='lucinda 8 italic', bg='black', fg='white',
       activebackground='white', activeforeground='black', command=bk).pack(side=RIGHT, anchor='n',padx=10)
